...
default['mysql']['tunable']['max_heap_table_size']  = default['mysql']['tunable']['tmp_table_size']
default['mysql']['tunable']['bulk_insert_buffer_size'] = default['mysql']['tunable']['tmp_table_size']
default['mysql']['tunable']['net_read_timeout']     = '30'
default['mysql']['tunable']['net_write_timeout']    = '30'
default['mysql']['tunable']['table_cache']          = '128'
default['mysql']['tunable']['table_open_cache']     = default['mysql']['tunable']['table_cache'] # table_cache is deprecated
